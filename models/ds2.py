...
from utils.paramet_tune import paramet_tune, Catboost_tuner, LOF_tuner, Kmeans_tuner, RandomForest_tuner, KNN_tuner
...
#     metrics_df.to_csv('./KNN(DS2).csv', index=False)
