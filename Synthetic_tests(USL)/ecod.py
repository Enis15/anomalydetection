...
plt.title('Dataset size vs Execution time (ECOD)')
# plt.savefig('ECOD_time.png', bbox_inches='tight')
...
plt.xlabel('Dataset size')
plt.ylabel('Score')
plt.title('Dataset size vs Evaluation Metrics (ECOD)')
plt.legend()
# plt.savefig('ECOD_metrics.png', bbox_inches='tight')
