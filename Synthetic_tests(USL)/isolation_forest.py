...
plt.title('Dataset size vs Execution time (IForest)')
# plt.savefig('IForest_time.png', bbox_inches='tight')
...
plt.xlabel('Dataset size')
plt.ylabel('Score')
plt.title('Dataset size vs Evaluation Metrics (IForest)')
plt.legend()
# plt.savefig('IForest_metrics.png', bbox_inches='tight')
