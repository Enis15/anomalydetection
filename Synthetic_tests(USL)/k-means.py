#K-Means as a clustering algorithm uses different evalution metrics
#than "traditional" classification algorithms.
...
# plt.savefig('CBLOF_time.png', bbox_inches='tight')
...
plt.xlabel('Dataset size')
plt.ylabel('Score')
plt.title('Dataset size vs Evaluation Metrics')
plt.legend()
# plt.savefig('CBLOF_metrics.png', bbox_inches='tight')
