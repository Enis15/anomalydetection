...
plt.title('Dataset size vs Execution time (COPOD)')
# plt.savefig('COPOD_time.png', bbox_inches='tight')
...
plt.xlabel('Dataset size')
plt.ylabel('Score')
plt.title('Dataset size vs Evaluation Metrics (COPOD)')
plt.legend()
# plt.savefig('COPOD_metrics.png', bbox_inches='tight')
