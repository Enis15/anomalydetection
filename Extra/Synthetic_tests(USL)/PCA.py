...
plt.title('Dataset size vs Execution time (PCA)')
# plt.savefig('PCA_time.png', bbox_inches='tight')
...
plt.xlabel('Dataset size')
plt.ylabel('Score')
plt.title('Dataset size vs Evaluation Metrics (PCA)')
plt.legend()
# plt.savefig('PCA_metrics.png', bbox_inches='tight')
