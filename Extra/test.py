...
from Extra.supervised_learning2 import model_knn, model_xgboost, model_svm, model_cb, model_nb, model_rf
# Unsupervised learning models
from utils.unsupervised_learning import model_lof, model_iforest, model_ecod, model_pca, model_dbscan, model_copod
# Hyperparameter tuning functions
from Extra.generate_data import (IsolationForest_tuner, KNN_tuner, XGBoost_tuner, Catboost_tuner, LOF_tuner,
...
if __name__ == '__main__':
    ...
    #     #xgboost_tuner = XGBoost_tuner(X_train, X_test, y_train, y_test)
    #     #best_xgboost_model = xgboost_tuner.tune_model()
    #     _logger.info(f'Best XGBoost Model: best_xgboost_model')
    #     xgboost_value = 140 # Save the value of n_estimators
    #     xgboost_depth = 8  # Save the value of max_depth
    #     xgboost_learn_rate =  0.154191477913669
    #
    ...
    #                                                                        xgboost_value, xgboost_depth, xgboost_learn_rate)
    ...
    #
    #     cb_iterations = 940
    #     cb_learning_rate = 0.16256564720212052
    #     cb_depth = 6
    ...
    #     unsupervised_metrics('LOF', lof_estimator, roc_auc_lof, f1_score_lof, precision_lof, recall_lof, accuracy_lof,
    #                          runtime_lof)
    #     _logger.info(
    ...
    #     unsupervised_metrics('PCA', None, roc_auc_pca, f1_score_pca, precision_pca, recall_pca, accuracy_pca,
    #                          runtime_pca)
    #     _logger.info(
    ...
    #     unsupervised_metrics('Isolation Forest', forest_estimator, roc_auc_if, f1_score_if, precision_if, recall_if,
    #                          accuracy_if, runtime_if)
    #     _logger.info(
    ...
    metrics_df.to_csv('../results/Metrics(DS1_holdout).csv', index=False)
