...
clf = RandomForestClassifier(n_estimators=1000, random_state=42) #Arbitrarly chooosen n_estimators & random_state
...
plt.title('Dataset size vs Execution time (Random Forest)')
# plt.savefig('RF_time.png', bbox_inches='tight')
...
plt.xlabel('Dataset size')
plt.ylabel('Score')
plt.title('Dataset size vs Evaluation Metrics (Random Forest)')
plt.legend()
# plt.savefig('RF_metrics.png', bbox_inches='tight')
