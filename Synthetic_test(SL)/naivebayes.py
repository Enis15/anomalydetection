...
plt.title('Dataset size vs Execution time (Naive Bayes)')
# plt.savefig('NaiveBayes_time.png', bbox_inches='tight')
...
plt.xlabel('Dataset size')
plt.ylabel('Score')
plt.title('Dataset size vs Evaluation Metrics (Naive Bayes)')
plt.legend()
# plt.savefig('NaiveBayes_metrics.png', bbox_inches='tight')
