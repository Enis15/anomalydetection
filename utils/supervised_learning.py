...
def model_knn(X, y, k, scorer, kf):
    ...
    print(f"Evaluation metrics for KNN model, with k = {k}, are: \n"
            f"ROC AUC: {results['test_roc_auc']} & Average ROC AUC Score {roc_auc_knn}\n"
            f"F1 score: {results['test_f1_score']} & Average F1 Score {f1_knn}\n" 
...
def model_nb(X, y, scorer, kf):
    ...
    print(f"Evaluation metrics for Naive Bayes model are: \n"
            f"ROC AUC: {results['test_roc_auc']} & Average ROC AUC Score {roc_auc_nb}\n"
            f"F1 score: {results['test_f1_score']} & Average F1 Score {f1_score_nb}\n" 
...
def model_rf(X, y, n_estimators, max_depth, scorer, kf):
    ...
    print(f"Evaluation metrics for Random Forest Classifier are: \n"
            f"ROC AUC: {results['test_roc_auc']} & Average ROC AUC Score {roc_auc_rf}\n"
            f"F1 score: {results['test_f1_score']} & Average F1 Score {f1_score_rf}\n" 
